...
const Mentee = ({ menteeForm }) => {
  return (
    <div>
      {menteeForm ? <div> Mentee </div> : <div> </div>}
      ...
      <div>
        ...
        <div className="language">
          <label className="question">
            In which other language would you like mentorship? (Note we cannot
            guarantee a mentor who speaks the same language but we will do our
            best!) *optional
          </label>
          <br></br>
          <br></br>
        ...
        <div className="message">
          <label className="question">
            Is there anything you would like to share with your mentor? :) (We
